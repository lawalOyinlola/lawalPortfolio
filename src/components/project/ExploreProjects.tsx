      ...
      <div className="wrapper py-13.5">
        ...
        >
          ...
          <div className="flex justify-end gap-2 mt-8 md:absolute md:-top-20 md:right-0 md:mt-0">
            <CarouselPrevious
              size="icon-lg"
              className="size-9 absolute top-13.5 -left-20! transform-none bg-background text-foreground border-foreground/20 hover:bg-foreground hover:text-background"
            />
            <CarouselNext
              size="icon-lg"
              className="size-9 absolute top-13.5 right-0 transform-none bg-background text-foreground border-foreground/20 hover:bg-foreground hover:text-background"
            />
          </div>
        </Carousel>
      </div>
